<#
.SYNOPSIS
    Get-PSProfiles.ps1 returns location, ownership and contents of local PowerShell profiles.
...
.DESCRIPTION
    ...
    To decode script field:
        Script text > decode from base64 > decode from Gunzip > profit
