<#
.SYNOPSIS
    Get-SharePermissions.ps1 enumerates the SMB shares on the target host and lists the share and NTFS access rights for them.
.NOTES
    Initial template form Kansa with modifications
#>

# Set erroraction preference
$ErrorActionPreference = "SilentlyContinue"

$output = If (Get-Command Get-SmbShare -ErrorAction SilentlyContinue) {
...
$output | unique -AsString | format-table -AutoSize -Wrap
