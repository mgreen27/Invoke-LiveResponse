...
Copy-LiveResponse -path "$env:systemdrive" -dest $Out -filter "swapfile.sys" -forensic
Copy-LiveResponse -path "$env:systemdrive" -dest $Out -filter "pagefile.sys" -forensic
